...
%% Save
save('wind_speed_props_yaw90_mean','wind_speed_mean');
save('wspi_voltage1_props_yaw90_mean','wspi_voltage1_mean');
save('wspi_voltage2_props_yaw90_mean','wspi_voltage2_mean');
save('wind_speed_props_yaw90_std','wind_speed_std');
save('wspi_voltage1_props_yaw90_std','wspi_voltage1_std');
save('wspi_voltage2_props_yaw90_std','wspi_voltage2_std');
save('wind_speed_props_yaw90_stderr','wind_speed_stderr');
save('wspi_voltage1_props_yaw90_stderr','wspi_voltage1_stderr');
save('wspi_voltage2_props_yaw90_stderr','wspi_voltage2_stderr');
