...
%% Save
save('wind_speed_props_yaw0_mean','wind_speed_mean');
save('wspi_voltage1_props_yaw0_mean','wspi_voltage1_mean');
save('wspi_voltage2_props_yaw0_mean','wspi_voltage2_mean');
save('wind_speed_props_yaw0_std','wind_speed_std');
save('wspi_voltage1_props_yaw0_std','wspi_voltage1_std');
save('wspi_voltage2_props_yaw0_std','wspi_voltage2_std');
save('wind_speed_props_yaw0_stderr','wind_speed_stderr');
save('wspi_voltage1_props_yaw0_stderr','wspi_voltage1_stderr');
save('wspi_voltage2_props_yaw0_stderr','wspi_voltage2_stderr');
